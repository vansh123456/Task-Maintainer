...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (errors.confirmPassword && e.target.value === confirmPassword) {
                        setErrors({ ...errors, confirmPassword: undefined, password: undefined });
                      }
                    }}
                    className={`appearance-none block w-full px-3 py-2 border ${
      ...
      <div className="hidden lg:block relative w-0 flex-1 bg-gradient-to-br from-indigo-600 via-purple-700 to-pink-800">
          ...
          <div className="max-w-md text-center">
            ...
            <div className="space-y-4 mt-12">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-left">Free forever plan</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-left">No credit card required</p>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-left">Get started in seconds</p>
              </div>
            </div>
          </div>
        </div>
